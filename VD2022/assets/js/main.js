(function ($) {
    ...
    VanillaTilt.init(document.querySelectorAll(".team-img"), {
        max: 33,
        speed: 2000,
        scale: 1.05,
        perspective: 2000,
    ...
    //Add Aria accessibilty labels for dots
    ...
    // Lity Lightbox setup
    //--------------------------------------------------
    $(document).on('click', '.colorbox', lity);
    ...
    function lazyLoader(){
        jQuery('img.lazy').each(function(){
            ...
            jQuery(this).parent().removeClass('lazy');
            jQuery(this).parent().parent().removeClass('lazy');
        });
    }
    ...
    function alm_adv_filter(category){

        var data = {};

        data['taxonomy'] = 'work_taxonomy';        
        //data['taxonomy-relation'] = 'AND';

         if(category == 'all'){
            data['taxonomy-terms'] = ''; 
         } else {
            data['taxonomy-terms'] = category; 
         }        
         
         //console.log("filter ALM: "+data['taxonomy-terms']);
         
         ajaxloadmore.$scroll = true;
         ajaxloadmore.$max_pages = 3;
         ajaxloadmore.filter('fade', '300', data);
     }   
    
    $('a.project-filter').on('click', function() {

        alm_adv_filter($(this).data('category'));
